...
Pod::Spec.new do |s|
  ...
  s.name         = "iOSATAPPSDK"
  s.version      = "0.0.1"
  s.summary      = "A short description of iOSATAPPSDK."
  ...
  s.description  = <<-DESC
	A short description of iOSATAPPSDK
                   DESC
  ...
  s.source       = { :git => "https://github.com/cataler/iOSATAPPSDK.git", :tag => s.version }
  ...
  s.source_files  =  "iOSATAPPSDK/ATLib/*.{h,m}"
